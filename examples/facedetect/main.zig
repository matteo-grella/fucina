...
test {
    ...
    _ = @import("nn.zig");
    _ = @import("nn_tests.zig");
    _ = @import("recognizer.zig");
    _ = @import("recognizer_tests.zig");
    _ = @import("genderage.zig");
    _ = @import("genderage_tests.zig");
    _ = @import("graph.zig");
    _ = @import("antispoof.zig");
    _ = @import("antispoof_tests.zig");
    _ = @import("landmarks.zig");
    _ = @import("landmarks_tests.zig");
    _ = @import("scrfd.zig");
    _ = @import("scrfd_tests.zig");
    _ = @import("detect.zig");
    _ = @import("detect_tests.zig");
    _ = @import("align.zig");
    _ = @import("align_tests.zig");
    _ = @import("preprocess.zig");
