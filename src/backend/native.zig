...
pub const kernels = struct {
    ...
    pub const pool_free_elementwiseContiguousIntoTyped = true;
    ...
    pub const pool_free_avgPool2dBackwardInto = true;
    pub const maxPool2dBackwardInto = vector.pool.maxPool2dBackwardInto;
    pub const pool_free_maxPool2dBackwardInto = true;
    ...
    pub const pool_free_preluChannelsBackwardInputInto = true;
    pub const preluChannelsBackwardAlphaInto = vector.elementwise.preluChannelsBackwardAlphaInto;
    pub const pool_free_preluChannelsBackwardAlphaInto = true;
    ...
    pub const pool_free_sumSliceTyped = true;
