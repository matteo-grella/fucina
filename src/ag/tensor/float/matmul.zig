...
pub fn Ops(comptime Self: type) type {
    return struct {
        ...
        pub fn dotPacked(
            ...
            comptime if (Rhs == backend_mod.quant.types.QuantizedMatmulRhsQ4_Kx4)
        ...
        pub fn rmsNormMulDotPacked(
            ...
            comptime {
                ...
                if (Rhs == backend_mod.quant.types.QuantizedMatmulRhsQ4_Kx2Mmla)
                    @compileError("rmsNormMulDotPacked: no fused MMLA kernel exists; use the unfused path (rmsNormMul + dotPacked)");
                if (Rhs == backend_mod.quant.types.QuantizedMatmulRhsQ4_Kx4)
        ...
        pub fn gegluQuantDotPacked(
            ...
            comptime if (Rhs != backend_mod.quant.types.QuantizedMatmulRhsQ8_0x4)
