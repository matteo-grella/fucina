...
/// segment boundaries). `models.research.engram` provides the graft adapter
/// (`ResidualGraft`).
...
pub fn Trainer(comptime targets: Targets) type {
    return struct {
        ...
        /// (`models/train/lora_trainer.zig`); qwen3 supplies only the projection
        ...
        /// cartridge fleets (`models/text/cartridge_fleet.zig`: callers append the
