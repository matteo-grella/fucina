...
`apps/nam/*.zig`; every deliberate deviation from upstream is documented at the point
...
```sh
fucina-nam render apps/nam/testdata/wavenet.nam v3_0_0.wav synth-reamp.wav
