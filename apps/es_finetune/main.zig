...
//! gradient-free counterpart of apps/finetune/main.zig, built for
...
/// LoRA on q and v projections — the same target set as apps/finetune/main.zig.
...
/// The pirate dataset from apps/finetune/main.zig, verbatim — apples to apples.
