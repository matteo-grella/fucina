...
```sh
zig build test                 # unit tests — EIGHT roots: src/fucina.zig, src/llm.zig, examples/nam.zig, examples/parakeet.zig, examples/omnivoice.zig, examples/locate_anything.zig, examples/facedetect.zig, examples/nanochat.zig
